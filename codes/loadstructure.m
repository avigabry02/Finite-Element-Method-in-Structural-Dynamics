...
% File opening
% eval(['fid_i=fopen(''','Assignment_2_input.inp'',''r'');']);

% File opening direttamente senza richiesta
fid_i = fopen('Assignment_2_input.inp', 'r');
if fid_i == -1
    error('Errore: File Assignment_2_input.inp non trovato.');
end
disp('File Assignment_2_input.inp aperto correttamente.');

file_i = 'Assignment_2_input.inp';
